...
**题3**：一信道比特率为4kb/s，传播延迟为20ms，问帧大小在多大范围内，停止等待协议至少有50%效率？
>解析：传输时间/(传输时间+时延)=50%，传输时间最大20ms，发送一帧所需时间40ms，4kb/s的信道，发送一位要0.25ms，`帧长=40/0.25=160b`

题4：一台主机ip地址为192.168.0.10,子网掩码为255.255.255.224，求主机所在网络的网络号所占位数。
...
- 式中ab的计算并不复杂，可以先计算出A,B然后看看能不能化简目标方程。file:///C:/Users/Administrator/AppData/Roaming/VNote/VNote/web/css/markdownit.css
